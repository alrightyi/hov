...
def transform_image(img, ang_range, shear_range, trans_range, brightness=False, seed=42):
    """
...
def augment_brightness(imagei, seed=42):
    hsv_img = hsv(image)
...
def rgbImage(imageFileName, resize=True):
    """
    ...
    if resize:
        ...
        image = cv2.resize(src=image, dsize=(64,64), interpolation=cv2.INTER_AREA)
